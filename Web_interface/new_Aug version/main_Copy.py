...
def test():
    print('running time lapse')
    time_lapse_control = time_lapse_module()
    time_lapse_control.save_images()
    return render_template('index.html');


@app.route("/autofocus", methods=['POST','GET'])
def autofocus():
...
def test2():
    ...
    print(parameters)
    testing_module = add_on_modules.test_modules()
